...
una successione.
Se
\(\exists \lim_{n \to +\infty} \sqrt[n]{a_n} = l \implies\) si ha: 
\begin{enumerate}
...
\pf{
Dimostrazione 1 (\(l>1\)) Se \(l>1\) \(a_n \to +\infty\).
...
\prop{
Criterio del rapporto (per le succ) Sia \(a_n > 0\) una
