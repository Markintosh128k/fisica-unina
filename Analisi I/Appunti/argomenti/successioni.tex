...
\end{cases}\quad (\text{non ha limite})\quad
\begin{align*}
& G_{n} = \sqrt[n]{a_{1}\dots  a_{n}} = 
\begin{cases}
...
\subsubsection{Teorema criterio Rapporto
Radice}\label{teorema-criterio-rapporto-radice}
...
\prop{
Criterio della radice (per le successioni) Sia \(a_n \ge 0\)
una successione. \\
...
\item
  ...
  \begin{align*} 0 \leq \frac{\log_2 n}{n^b} &= \frac{\log_2 \left( (n^{b/2})^{2/b} \right) }{ (n^{b/2})^2 } = \frac{ \frac{2}{b} \log_2(n^{b/2}) }{ (n^{b/2})^2 } \\ &= \frac{2}{b} \cdot \frac{\log_2(n^{b/2})}{n^{b/2} \cdot n^{b/2}} \\ &= \frac{2}{b} \cdot \frac{1}{n^{b/2}} \cdot \left( \frac{\log_2(n^{b/2})}{n^{b/2}} \right) \end{align*}
