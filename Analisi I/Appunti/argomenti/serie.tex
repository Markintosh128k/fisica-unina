...
\thm{Condizione necessaria per la convergenza}{
    Sia $\sum_{n=1}^{+\infty} a_{n}$ con $a_{n}$ una successione.
...
\prop{
    Consideriamo $\left( \sum_{n=1}^{+\infty} a_{n} \; , \; a_{n}\geq 0 \right)$.
...
\ex{
    \begin{itemize}
        ...
        \item $\displaystyle \sum_{n=1}^{+\infty} \left( 1-\cos \frac{1}{n} \right) \sim \sum_{n=1}^{+\infty} \frac{1}{n} \implies \text{Convergono}$
        \item 
        \begin{align*}
...
\thm{Criterio di Leibniz}{
    \begin{enumerate}
        ...
        \item Sia $a_{n}$ infinitesima ($\lim_{ n \to +\infty }a_{n}=0$)
    \end{enumerate}
